...
class Obat extends MY_Controller {
    ...
    public function tambah()
    {
        ...
        if ($msg == 'Berhasil ditambah') {
            $this->session->set_flashdata('info', '<div class="alert alert-success" role="alert">'.$msg.'...</div>');
            redirect('obat');
        }else{

            $this->session->set_flashdata('info', '<div class="alert alert-danger" role="alert">'.$msg.'...</div>');
            redirect('obat');
        }
    }
