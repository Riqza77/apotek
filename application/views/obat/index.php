				...
				<table class="table table-bordered" id="dataTable">
					...
					<tbody>
						<tr>
							...
							<!-- Tombol Aksi -->
							<td>
								<a href="<?php echo site_url('obat/hapus/') . $data->kode; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Data akan terhapus, Apakah Anda yakin?')"><i class="fa fa-trash"></i></a>
